# schema-guided-preprocessing

## Purpose

Scope aliases, value transforms, and structural folds to explicit schema locations before strict validation and schema-guided repair.
