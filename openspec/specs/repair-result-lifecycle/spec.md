# repair-result-lifecycle

## Purpose

Correlate repairs to tool-call IDs and surface local, value-free model and UI feedback across built-in and cooperating custom tools.
